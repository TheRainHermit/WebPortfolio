    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-section">
          <h3 className="footer-title">APADetector</h3>
          <p className="footer-description">
            Herramienta para verificar el cumplimiento de las normas APA en documentos académicos.
          </p>
          <div className="footer-social">
            <a href="https://github.com/tuusuario" target="_blank" rel="noopener noreferrer" className="social-link">
              <GitHubIcon className="social-icon" />
            </a>
            <a href="https://linkedin.com/in/tuperfil" target="_blank" rel="noopener noreferrer" className="social-link">
      ...
      <div className="footer-bottom">
        <p className="footer-copyright">
          &copy; {currentYear} APADetector. Todos los derechos reservados.
        </p>
      </div>
    </footer>
  );
